...
public class RobotContainer {
   ...
   // public final Mecanum cart = new Mecanum();
    ...
    private void configureButtonBindings() {
        ...
        new JoystickButton(joy, DC_MOTOR_BB3_ID).whenPressed(new InstantCommand(arm::Open));
        new JoystickButton(joy, DC_MOTOR_BB4_ID).whenPressed(new InstantCommand(arm::Close));
