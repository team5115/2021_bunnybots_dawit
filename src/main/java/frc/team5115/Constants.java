...
public class Constants{
    ...
    public static final int DC_MOTOR_BB_ID = 1;
    public static final int DC_MOTOR_BB2_ID = 3;
    public static final int DC_MOTOR_BB3_ID = 5;
    public static final int DC_MOTOR_BB4_ID = 6;
